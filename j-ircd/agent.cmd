...
set JIRCD_CLASSPATH=log4j.jar;jircd.jar;backport-util-concurrent.jar;GeoIP.jar;AgentMBean.jar;.
java %JMX_OPTS% %LOG_OPTS% %DEBUG_OPTS% %SSL_OPTS% -cp %JIRCD_CLASSPATH% managency.agent.AgentMBean managency.mbean.TaskScheduler file:agent.start file:agent.stop
