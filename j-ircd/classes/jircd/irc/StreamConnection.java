 ...
 * @author markhale
 */
public class StreamConnection extends Connection implements Runnable {
    ...
    public StreamConnection(Socket socket, ConnectionManager manager, ExecutorService pool) throws IOException {
    ...
    public final void run() {
        while (!Thread.interrupted()) {
            try {
                String line = input.readLine();   // accept common line terminators for maximum compatibility
