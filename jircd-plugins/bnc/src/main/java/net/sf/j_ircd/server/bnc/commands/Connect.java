...
package net.sf.j_ircd.server.bnc.commands;

import java.io.IOException;

import net.sf.j_ircd.server.jIRCdMBean;
import net.sf.j_ircd.server.bnc.BouncerHandler;
 ...
 * @author markhale
 */
public class Connect extends net.sf.j_ircd.server.irc.commands.Connect {
